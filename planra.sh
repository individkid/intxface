...
./vulkanCpp '$(Put Strhello ok againOp EndOp Op)'\
	...
	'Configurez(siz:5idx:0slf:-1cfg[0]:ManipLeftcfg[1]:ManipBasecfg[2]:ManipFixedcfg[3]:ScratchDescrscfg[4]:RegisterVoidval[0]:-20val[1]:-20val[2]:133val[3]:0val[4]:0)'\
	'Eval(res[0]:$(@memorys)fnc[0]:$(Fld @_ val @masks #3 Op))' 'Eval(res[0]:$(@memorys)fnc[0]:$(Fld @_ val @express << #8 #4 Op))'\
