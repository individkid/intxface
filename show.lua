...
function showMergeC(name,struct)
	...
	for ky,vl in ipairs(struct) do
		...
		elseif (Structz[vl[2]]~=nil) then
			result = result..showIndent(depth).."{enum DatxEnum repl = ("..func.."); struct "..vl[2].." temp = {0}; struct "..vl[2].." init = {0};\n"
		...
		elseif (vl[2] == "Str") then
			result = result..showIndent(depth).."{enum DatxEnum repl = ("..func.."); char *temp = 0; char *init = 0;\n"
		...
		elseif (vl[2] == "Dat") then
			result = result..showIndent(depth).."{enum DatxEnum repl = ("..func.."); void *temp = 0; void *init = 0;\n"
			...
			result = result..showIndent(depth).."{enum DatxEnum repl = ("..func.."); "..showTypeCF(vl[2]).." temp = {0}; "..showTypeCF(vl[2]).." init = {0};\n"
