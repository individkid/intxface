...
function indentwrite(line)
	...
	prefix = ""
	if indent < 1 then io.stderr:write("oops\n"); os.exit(-1) end
end
...
function copymake(values,target)
	...
	local depender = getdepender(target)
	indent = indent + 1; indentwrite("copymake"..saved..": "..depender.." "..match.." "..target.."\n",indent)
	if file == nil then indent = indent - 1; return false end
	if file ~= nil then io.close(file) end
...
function findsource(values,pre,post,ext,suf)
	...
	indent = indent + 1; indentwrite("findsource"..saved..": "..match.." "..ext.." "..suf.."\n",indent)
	while true do
...
function trymatch(values,target)
	...
	for line in io.lines("stderr."..target) do if uname == "Linux" then
		prefix = "1a "; if callmatch(values,line,"^/bin/sh: [%d]*: ./([%w]*C): not found$") and makecopy(values,target,"") then return trydone() end
		prefix = "1b "; if callmatch(values,line,"^/bin/sh: [%d]*: ./([%w]*Lua): not found$") and makecopy(values,target,"") then return trydone() end
		prefix = "1c "; if callmatch(values,line,"^/bin/sh: [%d]*: ./([%w]*Hs): not found$") and makecopy(values,target,"") then return trydone() end
		-- prefix = "2a "; if callmatch(values,line,"^make: *** No rule to make target '([%w]*)C'.  Stop.$") and copysource(values,target,".c") then return trydone() end
		prefix = "2b "; if callmatch(values,line,"^make: *** No rule to make target '([%w]*)C.o'.  Stop.$") and makecopy(values,target,".c") then return trydone() end
		prefix = "2c "; if callmatch(values,line,"^make: *** No rule to make target '([%w]*).c'.  Stop.$") and copysource(values,target,".c") then return trydone() end
		prefix = "2d "; if callmatch(values,line,"^make: *** No rule to make target '([%w]*)Lua'.  Stop.$") and copysource(values,target,".lua") then return trydone() end
		prefix = "2e "; if callmatch(values,line,"^make: *** No rule to make target '([%w]*)Hs'.  Stop.$") and copysource(values,target,".hs") then return trydone() end
		prefix = "2f "; if callmatch(values,line,"^make: *** No rule to make target '([%w]*).so'.  Stop.$") and makecopy(values,target,"C.o") then return trydone() end
		prefix = "2g "; if callmatch(values,line,"^make: *** No rule to make target '([%w]*)C'.  Stop.$") and makecopy(values,target,"C.o") then return trydone() end
		prefix = "2h "; if callmatch(values,line,"^make: *** No rule to make target '([%w]*).c'.  Stop.$") and copymake(values,target) then return trydone() end
		prefix = "2i "; if callmatch(values,line,"^make: *** No rule to make target '([%w]*).h'.  Stop.$") and copymake(values,target) then return trydone() end
		prefix = "2j "; if callmatch(values,line,"^make: *** No rule to make target '([%w]*)Lua'.  Stop.$") and makecopy(values,target,".lua") then return trydone() end
		prefix = "2k "; if callmatch(values,line,"^make: *** No rule to make target '([%w]*).lua'.  Stop.$") and copymake(values,target) then return trydone() end
		prefix = "2l "; if callmatch(values,line,"^make: *** No rule to make target '([%w]*)Hs'.  Stop.$") and makecopy(values,target,".hs") then return trydone() end
		prefix = "2m "; if callmatch(values,line,"^make: *** No rule to make target '([%w]*).hs'.  Stop.$") and copymake(values,target) then return trydone() end
		prefix = "2t "; if callmatch(values,line,"^make: *** No rule to make target '([%w]*)Cpp.o'.  Stop.$") and copysource(values,target,"Cpp.arg") then return trydone() end
		prefix = "2n "; if callmatch(values,line,"^make: *** No rule to make target '([%w]*)Cpp.o'.  Stop.$") and makecopy(values,target,".cpp") then return trydone() end
		prefix = "2o "; if callmatch(values,line,"^make: *** No rule to make target '([%w]*).cpp'.  Stop.$") and copysource(values,target,".cpp") then return trydone() end
		prefix = "2p "; if callmatch(values,line,"^make: *** No rule to make target '([%w]*)Cpp'.  Stop.$") and makecopy(values,target,"Cpp.o") then return trydone() end
		prefix = "2q "; if callmatch(values,line,"^make: *** No rule to make target '([%w]*)'.  Stop.$") and checksource(values,"c") and makecopy(values,target,"C") then return trydone() end
		prefix = "2r "; if callmatch(values,line,"^make: *** No rule to make target '([%w]*)'.  Stop.$") and checksource(values,"cpp") and makecopy(values,target,"Cpp") then return trydone() end
		prefix = "2s "; if callmatch(values,line,"^make: *** No rule to make target '([%w]*)'.  Stop.$") and checksource(values,"hs") and makecopy(values,target,"Hs") then return trydone() end
		prefix = "3a "; if callmatch(values,line,"^make: *** No rule to make target '([%w]*)Cpp.o', needed by '[%w.]*'.  Stop.$") and makecopy(values,target,".cpp") then return trydone() end
		prefix = "3b "; if callmatch(values,line,"^make: *** No rule to make target '([%w]*).c', needed by '[%w.]*'.  Stop.$") and copysource(values,target,".c") then return trydone() end
		prefix = "3c "; if callmatch(values,line,"^make: *** No rule to make target '([%w]*).h', needed by '[%w.]*'.  Stop.$") and copysource(values,target,".h") then return trydone() end
		prefix = "3d "; if callmatch(values,line,"^make: *** No rule to make target '([%w]*).cpp', needed by '[%w.]*'.  Stop.$") and copysource(values,target,".cpp") then return trydone() end
		prefix = "3e "; if callmatch(values,line,"^make: *** No rule to make target '([%w]*)C.o', needed by '[%w.]*'.  Stop.$") and makecopy(values,target,".c") then return trydone() end
		prefix = "3f "; if callmatch(values,line,"^make: *** No rule to make target '([%w]*).gen', needed by '[%w.]*'.  Stop.$") and copymake(values,target) then return trydone() end
		prefix = "3g "; if callmatch(values,line,"^make: *** No rule to make target '([%w]*).lua', needed by '[%w.]*'.  Stop.$") and copysource(values,target,".lua") then return trydone() end
		prefix = "3h "; if callmatch(values,line,"^make: *** No rule to make target '([%w]*).hs', needed by '[%w.]*'.  Stop.$") and copysource(values,target,".hs") then return trydone() end
		prefix = "4a "; if callmatch(values,line,"^[%w./]*:[%d]*:[%d]*: fatal error: ([%w]*).h: No such file or directory$") and copysource(values,target,".h") then return trydone() end
		prefix = "4b "; if callmatch(values,line,"^[%w./]*:[%d]*:[%d]*: fatal error: ([%w]*).h: No such file or directory$") and makecopy(values,target,".h") then return trydone() end
		prefix = "4c "; if callmatch(values,line,"^.*: fatal error: ([%w]*).cpp: No such file or directory$") and copysource(values,target,".cpp") then return trydone() end
		prefix = "5a "; if callmatch(values,line,"^.*: undefined reference to `([%w]*)'$") and findsource(values,"^[^[:space:]][^[:space:]]* *\\*?","\\(.*\\)$","c","C.o") and makecopy(values,target,"") then return trydone() end
		prefix = "5b "; if callmatch(values,line,"^.*: undefined reference to '([%w]*)'$") and findsource(values,"^[^[:space:]][^[:space:]]* *\\*?","\\(.*\\)$","c","C.o") and makecopy(values,target,"") then return trydone() end
		prefix = "5c "; if callmatch(values,line,"^.*: undefined reference to `([a-z]*)([A-Z][%w]*)'$") and findsource(values,"^"," = {","gen","C.o") and makecopy(values,target,"") then return trydone() end
		prefix = "5d "; if callmatch(values,line,"^.*: undefined reference to `([%w]*)'$") and findsource(values,"^[^[:space:]][^[:space:]]* *\\*?","\\(.*\\)$","cpp","Cpp.o") and makecopy(values,target,"") then return trydone() end
		prefix = "6a "; if callmatch(values,line,"^[%w]*C: cannot execute file: ([%w]*Lua)$") and makecopy(values,target,"") then return trydone() end
		prefix = "6b "; if callmatch(values,line,"^[%w]*C: cannot execute file: ([%w]*Hs)$") and makecopy(values,target,"") then return trydone() end
		prefix = "6c "; if callmatch(values,line,"^[%w]*Lua: cannot execute file: ([%w]*C)$") and makecopy(values,target,"") then return trydone() end
		prefix = "6d "; if callmatch(values,line,"^[%w]*Lua: cannot execute file: ([%w]*Hs)$") and makecopy(values,target,"") then return trydone() end
		prefix = "7a "; if callmatch(values,line,"^    Could not find module ‘([%w]*)’$") and findsource(values,"^module "," where$","hs","") and copysource(values,target,".hs") then return trydone() end
		prefix = "7b "; if callmatch(values,line,"^    Could not find module ‘([%w]*)’$") and findsource(values,"module "," where","gen",".hs") and makecopy(values,target,"") then return trydone() end
		prefix = "8a "; if callmatch(values,line,"^lua: cannot open ([%w]*).lua: No such file or directory$") and copysource(values,target,".lua") then return trydone() end
		prefix = "8b "; if callmatch(values,line,"^lua: cannot open ([%w]*).lua: No such file or directory$") and makecopy(values,target,".lua") then return trydone() end
		prefix = "9a "; if callmatch(values,line,"^lua: [%w./]*:[%d]*: module '([%w]*)' not found:$") and makecopy(values,target,".so") then return trydone() end
		prefix = "10a "; if callmatch(values,line,"[%w./]*%.so: undefined symbol: ([%w]*)$") and findsource(values,"^[^[:space:]][^[:space:]]* *","\\(.*\\)$","cpp","Cpp.o") and remakecopy(values,target,"") then return trydone() end
		prefix = "10b "; if callmatch(values,line,"[%w./]*%.so: undefined symbol: ([%w]*)$") and findsource(values,"^[^[:space:]][^[:space:]]* *","\\(.*\\)$","c","C.o") and remakecopy(values,target,"") then return trydone() end
